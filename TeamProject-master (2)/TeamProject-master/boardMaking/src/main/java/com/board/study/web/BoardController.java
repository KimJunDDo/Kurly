...
public class BoardController {
	...
	@GetMapping("/bulgogi")
	public String bulgogi() {
		return "/board/bulgogi";
	}
	@GetMapping("/fokara")
	public String fokara() {
		return "/board/fokara";
	}
	@GetMapping("/kongjju")
	public String kongjju() {
		return "/board/kongjju";
	}
	@GetMapping("/revolution")
	public String revolution() {
		return "/board/revolution";
	}
	@GetMapping("/alchon")
	public String alchon() {
		return "/board/alchon";
	}
	@GetMapping("/sinjeon")
	public String sinjeon() {
		return "/board/sinjeon";
	}
